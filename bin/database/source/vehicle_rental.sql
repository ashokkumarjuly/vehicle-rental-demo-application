...
-- Dumping data for table db_rental.auth_permissions: ~0 rows (approximately)
...
-- Dumping data for table db_rental.auth_roles: ~0 rows (approximately)
...
-- Dumping data for table db_rental.auth_role_permission: ~0 rows (approximately)
...
INSERT INTO `auth_role_permission` (`id`, `role_id`, `permission_id`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, '2021-08-28 23:08:26', '2021-08-28 23:08:26'),
	(2, 1, 2, '2021-08-28 23:08:26', '2021-08-28 23:08:26'),
	(3, 1, 3, '2021-08-28 23:08:26', '2021-08-28 23:08:26'),
	(4, 1, 4, '2021-08-28 23:08:26', '2021-08-28 23:08:26'),
	(5, 1, 5, '2021-08-28 23:08:26', '2021-08-28 23:08:26');
...
-- Dumping data for table db_rental.auth_user_role: ~0 rows (approximately)
DELETE FROM `auth_user_role`;
/*!40000 ALTER TABLE `auth_user_role` DISABLE KEYS */;
INSERT INTO `auth_user_role` (`id`, `user_id`, `role_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, NULL, '2021-12-05 02:58:31', '2021-12-05 02:58:33'),
	(2, 2, 3, NULL, '2021-12-05 08:01:45', '2021-12-05 08:01:45');
...
-- Dumping data for table db_rental.invoices: ~0 rows (approximately)
...
-- Dumping data for table db_rental.invoice_items: ~0 rows (approximately)
...
-- Dumping data for table db_rental.rentals: ~0 rows (approximately)
DELETE FROM `rentals`;
...
-- Dumping data for table db_rental.users: ~0 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `uid`, `first_name`, `last_name`, `email`, `password`, `customer_preferred_size`, `phone_code`, `phone_no`, `address`, `city`, `state`, `country`, `zip_code`, `status`, `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'cf2b79f2-1a1e-11ec-b199-000d3a5f9506', 'Admin', 'user', 'admin@mailinator.com', '$2b$12$No/xjAuL1fvryPc8.PnVVuaLR9CVcQso9r03oX3VhizW/KkRU2LJ6', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2021-12-05 01:53:08', NULL, NULL),
	(2, '938b7118-3e21-4257-b002-4525099f7e27', 'Clark', 'customer', 'customer_001@mailinator.com', '$2b$12$0DYv9DnPwl3Si0TgWy2VNuYktTJSB6A1Xx.S1g89BtLk9E2Aq7ymm', 1, '1', '2222222222', 'Iris Watson', 'Dallas', 'Texas', 'US', '75071', 1, 1, '2021-12-05 08:01:45', '2021-12-05 08:01:45', NULL);
...
-- Dumping data for table db_rental.user_wallet_amounts: ~0 rows (approximately)
DELETE FROM `user_wallet_amounts`;
/*!40000 ALTER TABLE `user_wallet_amounts` DISABLE KEYS */;
INSERT INTO `user_wallet_amounts` (`id`, `user_id`, `type`, `invoice_id`, `amount`, `created_at`, `updated_at`) VALUES
	(1, 2, 2, 0, 3000.00, '2021-12-05 08:01:45', '2021-12-05 08:01:45');
/*!40000 ALTER TABLE `user_wallet_amounts` ENABLE KEYS */;
...
-- Dumping data for table db_rental.variants: ~2 rows (approximately)
...
-- Dumping data for table db_rental.variant_values: ~6 rows (approximately)
DELETE FROM `variant_values`;
/*!40000 ALTER TABLE `variant_values` DISABLE KEYS */;
INSERT INTO `variant_values` (`id`, `variant_id`, `variant_value`, `created_at`, `updated_at`) VALUES
	(1, 1, 'red', '2021-12-05 06:47:12', NULL),
	(2, 1, 'blue', '2021-12-05 06:47:13', NULL),
	(3, 1, 'black', '2021-12-05 06:47:14', NULL),
	(4, 2, 'small', '2021-12-05 06:47:16', NULL),
	(5, 2, 'medium', '2021-12-05 06:47:17', NULL),
	(6, 2, 'large', '2021-12-05 06:47:18', NULL);
...
-- Dumping data for table db_rental.vehicles: ~1 rows (approximately)
DELETE FROM `vehicles`;
/*!40000 ALTER TABLE `vehicles` DISABLE KEYS */;
INSERT INTO `vehicles` (`id`, `uid`, `sku`, `fuel_type_id`, `vehicle_model_id`, `vehicle_variant_id`, `vehicle_no`, `status`, `hourly_rent`, `daily_rent`, `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, '32512c6f-7186-477b-b4f1-04f6388c24d7', 'Clark14', 1, 1, 2, 'TN36003', 1, 11, 50, 1, '2021-12-05 08:02:18', '2021-12-05 08:02:18', NULL),
	(3, 'e6274acb-07a3-4626-b6a6-0b47bc000be8', 'Clark15', 1, 1, 2, 'TN36004', 1, 11, 50, 1, '2021-12-05 08:04:18', '2021-12-05 08:04:18', NULL);
...
-- Dumping data for table db_rental.vehicle_fuel_types: ~0 rows (approximately)
DELETE FROM `vehicle_fuel_types`;
/*!40000 ALTER TABLE `vehicle_fuel_types` DISABLE KEYS */;
INSERT INTO `vehicle_fuel_types` (`id`, `name`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'Electric', 1, NULL, NULL),
	(2, 'LPG', 1, NULL, NULL),
	(3, 'Petrol', 1, NULL, NULL);
...
-- Dumping data for table db_rental.vehicle_make_models: ~0 rows (approximately)
DELETE FROM `vehicle_make_models`;
/*!40000 ALTER TABLE `vehicle_make_models` DISABLE KEYS */;
INSERT INTO `vehicle_make_models` (`id`, `name`, `vehicle_make`, `vehicle_type_id`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'Aerox 156', 'yamaha', 1, 1, '2021-12-05 13:32:18', '2021-12-05 13:32:18');
/*!40000 ALTER TABLE `vehicle_make_models` ENABLE KEYS */;
...
-- Dumping data for table db_rental.vehicle_types: ~2 rows (approximately)
DELETE FROM `vehicle_types`;
/*!40000 ALTER TABLE `vehicle_types` DISABLE KEYS */;
INSERT INTO `vehicle_types` (`id`, `name`, `is_active`, `created_at`, `updated_at`) VALUES
	(1, 'bike', 1, '2021-12-05 00:10:46', NULL),
	(2, 'scooter', 1, '2021-12-05 00:11:16', NULL);
